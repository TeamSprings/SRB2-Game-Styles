...
HOOK("ingameintermission", "sa2hud", function(v, p, t, e)
	...
	if transparency[index] ~= V_90TRANS then
		...
		font_drawer(v, 'SA2TL', FixedDiv(386*textscaling[index]-scorelen*textscaling[index]/4,
	...
	if transparency[index] ~= V_90TRANS then
		...
		font_drawer(v, 'SA2TL', 386*FRACUNIT, ztime-textscaling[index],
	...
	if transparency[index] ~= V_90TRANS then
		...
		font_drawer(v, 'SA2TL', FixedDiv(386*textscaling[index]-ringslen*textscaling[index]/4,
	...
	if transparency[index] ~= V_90TRANS then
		...
		font_drawer(v, 'SA2TL', FixedDiv(386*textscaling[index]-timelen*textscaling[index]/4,
	...
	if transparency[index] ~= V_90TRANS then
		...
		font_drawer(v, 'SA2TL', FixedDiv(386*textscaling[index],
